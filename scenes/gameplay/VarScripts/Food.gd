...
var Marianna=Customer.create("Marianna",7,8,25,[Carrot],[Cabbage],0,1)
var Wojciech=Customer.create("Wojciech",5,8,28,[Shroom, Chicken, Sausage, Potato, Cabbage],[Bark, Dandelion, Nettle])
var Zdzichu=Customer.create("Zdzichu",8,8,20,[Wodka,Egg,Potato, Cabbage],[Bark, Dandelion, Nettle,Bread])
var Richie=Customer.create("Richie",7,6,6,[Shroom, Carrot, Apple, Bark, Cabbage, Dandelion, Nettle, Potato, Turnip],[Chicken, Egg, Sausage, Wodka, Milk, Cheese])
var Danuta=Customer.create("Danuta",8,8,25,[Egg,Cheese,Sausage,Potato],[Shroom])
