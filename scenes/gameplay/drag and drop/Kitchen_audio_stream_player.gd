...
func _playSplash(volume:float=-15)->void:
...
func _playCashRegister()->void:
	self.stream=load("res://scenes/gameplay/drag and drop/sounds/freesound_community-cash-register-purchase-87313.mp3")
	self.volume_db=-20
	self.play()
