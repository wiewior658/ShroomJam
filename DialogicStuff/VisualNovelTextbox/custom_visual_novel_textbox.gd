...
@export var textbox_texture_margin_left: int = 8
@export var textbox_texture_margin_right: int = 8
@export var textbox_texture_margin_top: int = 8
@export var textbox_texture_margin_bottom: int = 8
...
func _apply_box_settings() -> void:
	...
	if ResourceLoader.exists(box_panel):
		...
		sb.set_texture_margin(SIDE_LEFT, textbox_texture_margin_left)
		sb.set_texture_margin(SIDE_RIGHT, textbox_texture_margin_right)
		sb.set_texture_margin(SIDE_TOP, textbox_texture_margin_top)
		sb.set_texture_margin(SIDE_BOTTOM, textbox_texture_margin_bottom)
...
func _apply_name_label_settings() -> void:
	...
	if ResourceLoader.exists(name_label_box_panel):
		...
		sb.set_texture_margin(SIDE_LEFT, label_texture_margin_left)
		sb.set_texture_margin(SIDE_RIGHT, label_texture_margin_right)
		sb.set_texture_margin(SIDE_TOP, label_texture_margin_top)
		sb.set_texture_margin(SIDE_BOTTOM, label_texture_margin_bottom)
